...
public class UtilHttp {
    ...
    public UtilHttp(String url, String returntype) {
        this.surl = url;
    ...
    public String sendGet() {
        ...
        try {
            String urlNameString = this.surl;
     ...
     * @return 所代表远程资源的响应结果
     */
    public String sendPost(Map<String, String> param) {
        PrintWriter out = null;
        BufferedReader in = null;
        this.sresult = "";
        try {
            URL realUrl = new URL(this.surl);
            // 打开和URL之间的连接
            ...
            for (Map.Entry<String, String> entry : param.entrySet()) {
                senddata = senddata + entry.getKey() + "=" + entry.getValue() + "&";
            }
